...
define('SIWE_DOMAIN_REGEX', $SIWE_DOMAIN_REGEX);
define('SIWE_ADDRESS_REGEX', $SIWE_ADDRESS_REGEX);
define('SIWE_STATEMENT_REGEX', $SIWE_STATEMENT_REGEX);
define('SIWE_VERSION_REGEX', $SIWE_VERSION_REGEX);
define('SIWE_CHAIN_ID_REGEX', $SIWE_CHAIN_ID_REGEX);
define('SIWE_NONCE_REGEX', $SIWE_NONCE_REGEX);
define('SIWE_URI_LINE_REGEX', $SIWE_URI_LINE_REGEX);
define('SIWE_ISSUED_AT_REGEX', $SIWE_ISSUED_AT_REGEX);
define('SIWE_EXPIRATION_TIME_REGEX', $SIWE_EXPIRATION_TIME_REGEX);
define('SIWE_NOT_BEFORE_REGEX', $SIWE_NOT_BEFORE_REGEX);
define('SIWE_REQUEST_ID_REGEX', $SIWE_REQUEST_ID_REGEX);
define('SIWE_RESOURCES_REGEX', $SIWE_RESOURCES_REGEX);
